...
const { getLeaderboard, updateProfile, updateBankDetails, getRewardHistory, getTransactionHistory, getDashboard, transferCoins, getUserByUniqueId, searchUser, payToUser } = require('../controllers/userController');
